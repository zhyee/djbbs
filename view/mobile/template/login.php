...
<form action="<?php echo $Config['WebsitePath']; ?>/login" method="post">
	<div class="input-group">
		...
		<input type="hidden" value="<?php echo $Config['WebsitePath']; ?>/" name="ReturnUrl" />
		...
		<p>
			<input type="text" name="VerifyCode" id="VerifyCode" placeholder="<?php echo $Lang['Verification_Code']; ?>" onclick="$(this).next().attr('src','<?php echo $Config['WebsitePath']; ?>/seccode.php')" value="" placeholder="<?php echo $Lang['Verification_Code']; ?>" style="width:66%;"/>
			<img src="" class="Verification_Code_Img" style="cursor: pointer;" onclick="this.src+=''" style="width:33%;" align="middle" />
			<br style="clear:both" />
		</p>
		<p>
