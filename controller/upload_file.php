...
switch (htmlspecialchars($_GET['action'])) {
	case 'uploadimage':
		$config    = array(
			"pathFormat" => $UploadConfig['imagePathFormat'],
	...
	case 'uploadscrawl':
		$config    = array(
			"pathFormat" => $UploadConfig['scrawlPathFormat'],
	...
	case 'uploadvideo':
		$config    = array(
			"pathFormat" => $UploadConfig['videoPathFormat'],
	...
	default:
		$config    = array(
			"pathFormat" => $UploadConfig['filePathFormat'],
